        ...
        <div class="contact-sidebar">
          ...
          <div class="contact-side-content">
            ...
            <div class="side-address">
              ...
              <a target="_blank" rel="noopener" href="https://www.google.com/maps?saddr=My+Location&daddr=<?php echo $address_line_one . $address_line_two ?>" class="fillall"><span
                  class="sr-only">Get Directions for <?php echo $address_line_one . $address_line_two ?> on Google Maps</span></a>
            </div>
            <?php } ?>
            ...
            <div class="contact-iframe">
              <iframe src="https://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q=<?php echo urlencode($address_line_one .' '. $address_line_two) ?>'&z=14&output=embed"
